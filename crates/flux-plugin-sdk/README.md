...
Rust SDK for writing [Horizon Flux](https://github.com/horizon-analytic/horizon_flux)
...
repo](https://github.com/horizon-analytic/flux-plugin-template):
...
>
> After flux reaches 1.0, the SDK will follow semver in the usual way, and
