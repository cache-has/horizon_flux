...
//!
//! Plugins write log lines to **stderr**, which the armillary host captures and
//! re-emits through `tracing` (see `armillary-plugin-host::process` for the
