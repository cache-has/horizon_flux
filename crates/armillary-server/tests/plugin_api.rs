...
use armillary_plugin_host::{PluginRegistry, discover_plugins_in};
...
fn state_with_registry_and_roots(
    ...
    AppState {
        ...
        connector_registry: Arc::new(armillary_connectors::ConnectorRegistry::new()),
...
fn router(state: AppState) -> Router {
    Router::new()
        .nest("/api/plugins", armillary_server::api::plugins::router())
        .with_state(state)
}
