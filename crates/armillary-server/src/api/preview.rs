...
use armillary_datafusion::PipelineExecutor;
use armillary_datafusion::compute_column_stats;
use armillary_datafusion::preview::sample_batches;
use armillary_engine::NodeId;
use armillary_engine::node::{SourceConfig, TransformMode};
use armillary_engine::sample::SampleConfig;
use armillary_engine::variables::ResolvedVariables;
                ...
                match mode {
                    ...
                    TransformMode::Python => {
                        let variables = var_resolver
                            ...
                            .unwrap_or_default();
                        let py_config = armillary_datafusion::PythonConfig::default();
                        armillary_datafusion::python_runtime::execute_python_transform(
                            &code,
                            upstream_refs,
                            &variables,
                            &py_config,
...
fn build_preview_response(
    ...
    Ok(Json(PreviewNodeResponse {
        ...
        rows,
        column_stats,
        status: armillary_datafusion::PreviewStatus::ReExecuted,
    }))
}
